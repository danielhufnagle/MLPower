 ...
 *
 * This is the OFFICIAL Linux kernel driver for the INA3221
 * Source: https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/tree/drivers/hwmon/ina3221.c
 * Your Jetson is running this driver in kernel 5.15.185-tegra
 */
...
#define INA3221_CRIT1			0x07  /* Critical alert threshold */
#define INA3221_WARN1			0x08  /* Warning alert threshold */
#define INA3221_CRIT2			0x09
#define INA3221_WARN2			0x0a
#define INA3221_CRIT3			0x0b
#define INA3221_WARN3			0x0c
#define INA3221_SHUNT_SUM		0x0d  /* SUM of all shunt voltages */
#define INA3221_CRIT_SUM		0x0e  /* Critical threshold for sum */
#define INA3221_MASK_ENABLE		0x0f  /* Alert flags register */
...
static int ina3221_read_in(struct device *dev, u32 attr, int channel,
			   long *val)
{
...
static int ina3221_read_curr(struct device *dev, u32 attr, int channel,
			     long *val)
{
	struct ina3221_data *ina = dev_get_drvdata(dev);
	struct ina3221_input *input = ina->inputs;
...
static int ina3221_write_curr(struct device *dev, u32 attr, int channel,
			      long val)
{
	struct ina3221_data *ina = dev_get_drvdata(dev);
	struct ina3221_input *input = ina->inputs;
...
static int ina3221_read_string(struct device *dev,
...
/* shunt resistance */
static SENSOR_DEVICE_ATTR_RW(shunt1_resistor, ina3221_shunt,
			     INA3221_CHANNEL1);
static SENSOR_DEVICE_ATTR_RW(shunt2_resistor, ina3221_shunt,
			     INA3221_CHANNEL2);
static SENSOR_DEVICE_ATTR_RW(shunt3_resistor, ina3221_shunt,
			     INA3221_CHANNEL3);
...
static int ina3221_probe(struct i2c_client *client)
{
	...
	for (i = 0; i < F_MAX_FIELDS; i++) {
		ina->fields[i] = devm_regmap_field_alloc(dev, ina->regmap,
